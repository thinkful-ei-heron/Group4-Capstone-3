					...
					<section className="form-section">
						<fieldset>
							...
							<div>
								...
								<input
									type="text"
									id="beer-entry-location"
									value={this.context.location}
									onChange={(e) => this.context.setLoc(e.target.value)}
									required
								/>
							</div>
							...
							<div>
								...
								<select
									...
									onChange={(e) => this.context.setType(e.target.value)}
									required
								>
							...
							<div className="abv-input">
								<label htmlFor="beer-entry-abv" data-tip="Alcohol By Volume">
									ABV
								</label>
								...
								<input
									type="number"
									id="beer-entry-abv"
									value={this.context.abv}
									onChange={(e) => this.context.setAbv(e.target.value)}
									required
								/>
							</div>

							<div>
								<label htmlFor="beer-entry-color" data-tip="Color of beer">
									Dark to Light
								</label>
								<span className="required">*</span>
								<input
							...
							<div>
								<label htmlFor="beer-entry-heaviness" data-tip="Strength of alcohol">
									Heavy to Light
								</label>
								<span className="required">*</span>
								<input
						...
						<fieldset className="lastfield">
							...
							<div>
								...
								<input
									...
									onChange={(e) => this.context.setRating(e.target.value)}
									className="slider"
									id="rating"
									step="1"
								/>
							...
							<label className="desc-label" htmlFor="beer-entry-rating">
								Description
							</label>
							<span className="required">*</span>
							<textarea
								id="beer-entry-description"
								value={this.context.description}
								onChange={(e) => this.context.setDesc(e.target.value)}
								required
							/>
