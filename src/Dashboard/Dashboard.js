            ...
            return this.state.beerList.map((beerList, i) => (beerList.expanded) ?
                ...
                <div className='beerList-item' key={i}>
                    <button
                        ...
                        <h4>{beerList.name}</h4>
                        <img className='rating-img' src={Utils.getRatingImage(beerList.rating)} alt={'Rating icons'}
                             height={'50px'}/>
                ...
                <main className='dashboard-page'>
                    ...
                    <section className='dashboard-bottom'>
                        ...
                        <span className="radio-group">
                            ...
                            <input type="radio" value="small-icons" id="small-icons" className="hidden"
                                   checked={this.state.selectedOption === 'small-icons'}
                                   onChange={this.handleOptionChange}/>
                            <label htmlFor="small-icons"><img src={SmallIcon} alt='small icon view' height='20px'
                                                              width='20px' id='small-icons-img'
                                                              className='inactiveClass'/></label>

                            <input type="radio" value="large-icons" id="large-icons" className="hidden"
                                   checked={this.state.selectedOption === 'large-icons'}
                                   onChange={this.handleOptionChange}/>
                            <label htmlFor="large-icons"><img src={LargeIcon} alt='large icon view' height='20px'
                                                              width='20px' id='large-icons-img'
                                                              className='activeClass'/></label>

                            <input type="radio" value="list" id="list" className="hidden"
                                   checked={this.state.selectedOption === 'list'} onChange={this.handleOptionChange}/>
                            <label htmlFor="list"><img src={ListIcon} alt='list view' height='20px' width='20px'
                                                       id='list-img' className='inactiveClass'/></label>

                            <input type="radio" value="details" id="details" className="hidden"
                                   checked={this.state.selectedOption === 'details'}
                                   onChange={this.handleOptionChange}/>
                            <label htmlFor="details"><img src={DetailsIcon} alt='detailed view' height='20px'
                                                          width='20px' id='details-img'
                                                          className='inactiveClass'/></label>
